...
class Ui_UrunEkleForm(object):
    def setupUi(self, UrunEkleForm):
        ...
        UrunEkleForm.resize(450, 240)
        UrunEkleForm.setMaximumSize(QtCore.QSize(450, 240))
        font = QtGui.QFont()
        font.setPointSize(12)
        UrunEkleForm.setFont(font)
        self.formLayoutWidget = QtWidgets.QWidget(UrunEkleForm)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 10, 431, 211))
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.urun_ekle_button)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.urun_temizle_button)
