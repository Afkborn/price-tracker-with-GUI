...
class Ui_UrunEkleForm(object):
    def setupUi(self, UrunEkleForm):
        ...
        UrunEkleForm.resize(450, 220)
        UrunEkleForm.setMaximumSize(QtCore.QSize(450, 220))
        font = QtGui.QFont()
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.urun_ekle_button)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.urun_temizle_button)
